...
class Vector3 {
    ...
    div(scalar) {
        ...
        t = [t[0] / scalar, t[1] / scalar, t[2] / scalar];
        this.elements = t;
        // Don't delete the return statement.
        return this;
    };
    ...
    static dot(other1, other2) {
        ...
        let firstElements = other1.elements;
        let secondElements = other2.elements;

        d = (firstElements[0] * secondElements[0]) + (firstElements[1] * secondElements[1]) + (firstElements[2] * secondElements[2]);
        // Don't delete the return statement.
        return d;
    }
    ...
    static cross(other1, other2) {
        ...
        v3.elements = [cX,cY,cZ];
        //console.log("cross: ", v3);
        // Don't delete the return statement.
        return v3;
    }
    ...
    magnitude() {
        ...
        m = Math.sqrt(((Math.pow(elements[0],2)) + (Math.pow(elements[1],2)) + (Math.pow(elements[2],2))));
        // Don't delete the return statement.
        return m;
    };
    ...
    normalize() {
        ...
        this.elements = [elements[0] / m, elements[1] / m, elements[2] / m]
        // Don't delete the return statement.
        return this;
    };
}
